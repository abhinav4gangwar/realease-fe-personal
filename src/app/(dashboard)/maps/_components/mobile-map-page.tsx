...
import MobilePropertyList from './mobile-property-sheet'
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <button
        ...
        className="absolute top-4 right-4 z-100 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg hover:shadow-xl transition-shadow"
      ...
      {isLoadingKml && (
        <div className="absolute top-4 left-4 z-[1000] rounded-lg bg-white px-3 py-2 shadow-lg">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-700">Loading KML...</span>
          </div>
        </div>
      )}
