...
const ReportAnalyticsBasicCard = ({ heading, value, insight, color }: CardTypes) => {
  return (
      ...
      <div className="text-secondary flex items-center justify-between">
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="text-secondary max-w-sm border border-gray-400 bg-white shadow-md">
...
export default ReportAnalyticsBasicCard
