  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-lg border border-gray-500 bg-white shadow-lg">
        <div className="p-6">
          <h2 className="mb-2 text-xl font-semibold text-center">Delete Properties</h2>
          <p className="mb-6 text-gray-600 text-center">
            Are you sure you want to delete {selectedCount} selected propertie
            {selectedCount > 1 ? 's' : ''}?
          </p>
...
export default BulkDeletePropertyModal
