  ...
  return (
    <div className="flex items-center rounded-full border border-gray-400">
      <Button
        ...
        className={`h-12 px-6 ${accessControlState === 'users' ? 'bg-secondary rounded-full text-white' : 'text-secondary bg-transparent'} cursor-pointer rounded-l-full`}
      >
        Users
      </Button>
      ...
      <Button
        ...
        className={`h-12 px-6 ${accessControlState === 'permissions' ? 'bg-secondary rounded-full text-white' : 'text-secondary bg-transparent'} cursor-pointer rounded-r-full`}
      >
        Permissions
      </Button>
    </div>
